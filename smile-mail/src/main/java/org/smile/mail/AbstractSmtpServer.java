 ...
 */
public abstract class AbstractSmtpServer<T extends SendMailSessionProvider> implements SendMailSessionProvider,Strings{
	 ...
	 */
	public AbstractSmtpServer(String host) {
		this.host = host;
	 ...
	 */
	public AbstractSmtpServer(String host, int port) {
		this.host = host;
		this.port = port;
	}
