 ...
 */
public class SmtpSslServer extends AbstractSmtpServer<SmtpSslServer> {
	...
	protected Properties createSessionProperties() {
		...
		props.setProperty(MAIL_SMTP_STARTTLS_REQUIRED,
			startTlsRequired ? Strings.TRUE : Strings.FALSE);

		props.setProperty(MAIL_SMTP_STARTTLS_ENABLE, Strings.TRUE);
		...
		props.setProperty(MAIL_SMTP_SOCKET_FACTORY_FALLBACK, Strings.FALSE);
