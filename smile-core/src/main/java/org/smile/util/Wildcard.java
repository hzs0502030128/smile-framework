 ...
 * Possible patterns allow to match single 
 * characters ('?') or any count of characters ('*'). Wildcard characters can be escaped (by an '\').
...
public class Wildcard {
	...
	protected static final char[] PATH_SEPARATORS = new char[]{'/','\\'};
	...
	public static boolean matchPath(String path, String pattern) {
		String[] pathElements = StringUtils.splitc(path, PATH_SEPARATORS);
		String[] patternElements = StringUtils.splitc(pattern, PATH_SEPARATORS);
