	...
	private <T> T getRequiredAttributeWithAlias(String attributeName, Class<? extends Annotation> annotationType,
		...
		if (aliasNames != null) {
			for (String aliasName : aliasNames) {
				...
				boolean attributeEmpty = Objects.isEmpty(attributeValue);
				boolean aliasEmpty = Objects.isEmpty(aliasValue);

				if (!attributeEmpty && !aliasEmpty && !Objects.nullSafeEquals(attributeValue, aliasValue)) {
					...
					throw new SmileRunException(msg);
				}
