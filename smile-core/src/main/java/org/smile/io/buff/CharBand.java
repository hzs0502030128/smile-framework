 ...
 */
public class CharBand implements CharSequence, Appendable{
	 ...
	 */
	public CharBand() {
		this.minChunkLen = IOUtils.DEFAULT_BUFF_SIZE/2;
	}
	 ...
	 */
	public CharBand append(char[] array, int off, int len) {
		int end = off + len;
	 ...
	 * Appends <code>char</code> array to buffer.
	 */
	public CharBand append(char[] array) {
	 ...
	 */
	@Override
	public CharBand append(char element) {
	 ...
	 */
	public CharBand append(CharBand buff) {
		if (buff.size == 0) {
			return this;
		}
	...
	public String toString() {
		return new SharedString(toArray()).toString();
	}
	...
	public CharSequence subSequence(int start, int end) {
		int len = end - start;
		return new StringBuilder(len+16).append(toArray(start, len));
	}
	 ...
	 */
	public CharBand append(String string) {
	 ...
	 */
	@Override
	public CharBand append(CharSequence csq) {
	 ...
	 */
	@Override
	public CharBand append(CharSequence csq, int start, int end) {
