 ...
 * {@link DateTime} and it contains few utilities that may be used
 * elsewhere, although {@link DateTime} is recommended for all time
 * manipulation.
 */
public class TimeUtil {
	 ...
	 */
	public static JulianDate toJulianDate(DateTimeStamp time) {
	 ...
	 */
	public static JulianDate toJulianDate(int year, int month, int day, int hour, int minute, int second, int millisecond) {
	...
	public static DateTimeStamp fromJulianDate(double JD) {
		return fromJulianDate(new JulianDate(JD));
	}
	 ...
	 * @return time stamp
	 */
	public static DateTimeStamp fromJulianDate(JulianDate jds) {
	 ...
	 */
	public static int getOffset(DateTime jdt, TimeZone tz) {
		return tz.getOffset(
				jdt.getEra(),
				jdt.getYear(),
				jdt.getMonth() - 1,
	 ...
	 * @return
	 */
	public static int getOffsetDifference(DateTime jdt, TimeZone from, TimeZone to) {
