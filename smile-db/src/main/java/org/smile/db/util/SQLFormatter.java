...
public class SQLFormatter {
	...
	private static final Set<String> NO_NEW_LINE=new HashSet<String>();
	public static final String WHITESPACE = " \n\r\f\t";
	public static final RegExp reg=new RegExp("[\r\n ]+");
	static {
		...
		NO_NEW_LINE.add("from");
		NO_NEW_LINE.add("join");
		NO_NEW_LINE.add("where");
	}
	...
	public static String format(String source) {
		...
		return new FormatProcess(reg.replaceAll(source," ")).perform();
	}
	
	public static void formatSqlFile(String file) throws Exception{
		InputStream is=new BufferedInputStream(new FileInputStream(file));
		String sql=format(IOUtils.readString(is));
		IOUtils.write(new File(file), sql);
	}
	...
	private static class FormatProcess {
		...
		private void endNewClause() {
			...
			if(!NO_NEW_LINE.contains(lcToken)){
				newline();
			}else{
				result.append(" ");
			}
